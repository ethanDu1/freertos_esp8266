...
#define UIOT_MY_DEVICE_SN             "2074x9zutckr3ylu"

#define UIOT_MY_PRODUCT_SECRET        "0807n7wvrzysn8e8"
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void auth_test(void *pvParameters)
{
    int ret = 0;
...
int main(void)
{
  ...
  xTaskCreate(auth_test, "auth_test", 2000, NULL, 1, NULL);
