...
void event_handler(void *pClient, void *handle_context, MQTTEventMsg *msg) {
	...
	switch(msg->event_type) {
		...
		case MQTT_EVENT_SUBSCRIBE_SUCCESS:
			printf("subscribe success, packet-id=%u", (unsigned int)msg->msg);
		...
		case MQTT_EVENT_PUBLISH_SUCCESS:
			printf("publish success1, packet-id=%u", (unsigned int)msg->msg);
			break;
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void mqtt_test(void *pvParameters)
{
    int ret = 0;
...
int main(void)
{
  ...
  xTaskCreate(mqtt_test, "mqtt_test", 2000, NULL, 1, NULL);
