...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void ota_test(void *pvParameters)
{
    int rc;
    int ota_over = 0;
...
int main(void)
{
  ...
  xTaskCreate(ota_test, "ota_test", 2000, NULL, 1, NULL);
  /* USER CODE END RTOS_THREADS */
  //xTaskCreate(mqtt_yield, "mqtt_yield", 2000, mqtt_client, 1, NULL);
  /* Start scheduler */
  osKernelStart();
